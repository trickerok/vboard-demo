  ...
  return (
    <div className="flex h-screen w-full flex-col bg-zinc-100">
      ...
      <main className="flex-1 relative overflow-hidden">
        {socket && roomId ? (
          <Canvas socket={socket} roomId={roomId} bgPattern={bgPattern} setBgPattern={setBgPattern} bgColor={bgColor} setBgColor={setBgColor} gridSize={gridSize} setGridSize={setGridSize} localUserId={localUserId} localUserName={localUserName} localUserColor={localUserColor} />
        ) : (
